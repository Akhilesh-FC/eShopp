    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="{{ route('color') }}" method="GET" class="form-inline">
                <input type="text" name="search" value="{{ request('search') }}" class="form-control mr-2" placeholder="Search colors...">
        ...
        <div class="col-md-6 text-right">
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addColorModal">Add Color</button>
        </div>
    </div>
    ...
    <table class="table table-bordered mt-4">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $color->name }}</td>
                <td>
                    <span style="background-color: {{ $color->color }}; color: {{ $color->color }}; font-size: 20px; padding: 5px;">
                        &#x25A0;
                    </span>
                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('color.store') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary btn-block">Save Color</button>
                    </form>
                </div>
            </div>
        </div>
