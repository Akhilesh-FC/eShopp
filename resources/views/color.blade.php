                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('color.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                   ...
                                   <input type="color" class="form-control" id="color" name="color" required style="width: 100%; height: 40px; padding: 5px;">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="editColorForm" method="POST" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="color" class="form-control" id="editColor" name="color" required style="width: 100%; height: 40px; padding: 5px;">
                                </div>
                                <div class="form-group">
