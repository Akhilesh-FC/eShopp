            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-info">
                        <!-- form start -->
                        <form class="form-horizontal form-submit-event" method="POST" action="#" enctype="multipart/form-data">
                            <div class="card-body">
