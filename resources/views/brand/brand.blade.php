                    ...
                    <div class="card content-area p-4">
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <a href="https://avrluxe.com/admin/brand/create-brand" class="btn btn-block  btn-outline-primary btn-sm">Add Brand</a>
                            </div>
                        </div>
