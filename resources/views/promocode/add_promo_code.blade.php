...
<div class="page-wrapper">
    ...
    @method('POST')
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label for="min_discount_amount">Miximum Discount Amount</label>
                    <input type="number" class="form-control" id="max_discount_amount" name="max_discount_amount" step="0.01" required>
                </div>

                <!-- Minimum Order Amount -->
                <div class="col-md-6 mb-3">
                    <label for="min_order_amount">Minimum Order Amount</label>
                    <input type="number" class="form-control" id="minimum_order_amount" name="minimum_order_amount" step="0.01" required>
                </div>
            </div>
