            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    ...
                    @if($vendor->upload_adharcard)
                        <img src="{{ $vendor->upload_adharcard }}" alt="Aadhaar Image" class="img-fluid img-thumbnail" style="object-fit: cover; height: 300px; width:400px;">
                    @else
                ...
                <div class="col-md-6 mb-4">
                    ...
                    @if($vendor->vendor_image)
                        <img src="{{ $vendor->vendor_image }}" alt="Vendor Photo" class="img-fluid img-thumbnail" style="object-fit: cover; height: 300px; width:400px;">
                    @else
                ...
                <div class="col-md-6 mb-4">
                    ...
                    @if($vendor->upload_gst)
                        <img src="{{ $vendor->upload_gst }}" alt="GST Image" class="img-fluid img-thumbnail" style="object-fit: cover; height: 300px; width:400px;">
                    @else
                ...
                <div class="col-md-6 mb-4">
                    ...
                    @if($vendor->upload_pan)
                        <img src="{{ $vendor->upload_pan }}" alt="PAN Image" class="img-fluid img-thumbnail" style="object-fit: cover; height: 300px; width:400px;">
                    @else
