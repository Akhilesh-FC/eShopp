                    ...
                    <div class="card content-area p-4">
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <a href="#" class="btn btn-block  btn-outline-primary btn-sm">Add Delivery Boy </a>
                            </div>
                        </div>
                        <div class="card-innr">
