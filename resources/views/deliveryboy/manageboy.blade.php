...
<form action="{{route('manage_delivery_boy')}}" method="get"></form>
                ...
                <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id='fund_transfer_delivery_boy'>
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-0">
                                <form class="form-horizontal form-submit-event" action="https://avrluxe.com/admin/fund_transfer/add-fund-transfer" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card content-area p-4">
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <a href="https://avrluxe.com/admin/delivery_boys/" class="btn btn-block  btn-outline-primary btn-sm">Add Delivery Boy </a>
                            </div>
                        </div>
                        <div class="card-innr">
