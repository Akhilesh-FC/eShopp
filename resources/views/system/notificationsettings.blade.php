...
<div class="page-wrapper">
    ...
    <form action="{{ route('notification_settings') }}" method="get"></form>
                                ...
                                <div class="form-group">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="fcm_server_key" placeholder='FCM Server Key' rows="5">your_fcm_server_key</textarea>
                                        </div>
                                    </div>
                                </div>
