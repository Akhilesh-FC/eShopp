...
@section('admin')
    ...
    <form action="{{ route('admin_policies') }}" method="get"></form>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-info">
            <!-- form start -->
            <form class="form-horizontal form-submit-event" action="https://avrluxe.com/admin/admin_privacy_policy/update-privacy-policy-settings" method="POST" enctype="multipart/form-data">
              <div class="card-body pad">
                <label for="other_images"> Privacy Policy </label>
                <a href="https://avrluxe.com/admin/admin-privacy-policy/privacy-policy-page" target='_blank' class="btn btn-primary btn-xs" title='View Privacy Policy'><i class='fa fa-eye'></i></a>
                <div class="mb-3">
