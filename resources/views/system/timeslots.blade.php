        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="card card-info">
                            <!-- form start -->
                            <form class="form-horizontal form-submit-event" action="https://avrluxe.com/admin/Time_slots/update_time_slots_config" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <!-- form start -->
                        <form class="form-horizontal form-submit-event" action="https://avrluxe.com/admin/Time_slots/update_time_slots" method="POST" enctype="multipart/form-data">
