...
//             'product_variants.is_added' // Include is_added column in the select
//         ]);
...
//     // Separate products based on the value of 'is_added'
//     $addedProducts = $products->filter(function ($product) {
//         return $product->is_added == 1; // Filter products where is_added = 1
//     });

//     $notAddedProducts = $products->filter(function ($product) {
//         return $product->is_added == 0; // Filter products where is_added = 0
//     });

//     // Return response based on the 'is_added' condition
//     return response()->json([
//     'success' => true,
//     'data' => $products,  // All products fetched from the database
//     'added_products' => $addedProducts, // Products that are added (is_added = 1)
//     'not_added_products' => $notAddedProducts, // Products that are not added (is_added = 0)
// ], 200);
// }
